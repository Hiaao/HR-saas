  ...
  <div class="dashboard-container">
    ...
    <el-card class="header-card">
      <div>
        <div class="fl headL">
          <div class="headImg">
            <img v-imageerror="defaultPhoto" :src="staffPhoto">
          </div>
    ...
    <el-row type="flex" justify="space-between">
      ...
      <el-col :span="11">
        <el-card class="box-card">
          ...
          <div class="sideNav">
            <el-button class="sideBtn" @click="isShowDialog = true">加班离职</el-button>
    ...
    <!-- 离职加班弹层 -->
    <el-dialog :visible="isShowDialog" title="离职申请" @close="btnCancel">
      <!-- 表单 -->
      <el-form ref="ruleForm" :model="ruleForm" :rules="rules" label-width="120px">
        <el-form-item label="期望离职时间" prop="exceptTime">
          <el-date-picker v-model="ruleForm.exceptTime" placeholder="请输入时间" type="datetime" value-format="yyyy-MM-dd HH:mm:ss" />
        </el-form-item>
        <el-form-item label="离职原因" prop="reason">
          <el-input v-model="ruleForm.reason" placeholder="请输入内容" style="width: 70%" type="textarea" :rows="3" />
        </el-form-item>
      </el-form>
      <!-- 确定取消 -->
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        exceptTime: [{ required: true, message: '离职时间不能为空', trgger: 'blur' }],
        reason: [{ required: true, message: '离职原因不能为空', trgger: 'blur' }]
      }
    }
  },
  computed: {
